 ...
 *    This object belongs to Nightmare LPMud and is NOT part of
 *    the Nightmare LPC Library distribution
 *    Any use of this object or the code contained within
 *    outside of Nightmare LPMud without the express written
 *    permission of the Nightmare LPMud administration is prohibted
 *    copyright (c) 1995 Nightmare LPMud
