...
static void MainMenu() {
    ...
    tmp = center("Nightmare V Emote Editor", screen[0]) + "\n";
...
static void ShowEmote(string emote) {
    ...
    int array screen = this_player()->GetScreen() || ({ 80, 25 });
    string tmp = center("Nightmare V Emote Editor", screen[0]) + "\n\n";
...
string GetHelp(string str) {
    return ("Syntax: <addemote>\n"
	    ...
	    "rules and the Nightmare V messaging system.  In order to add "
